...
; CHECK:      Illegal use of unrelocated value in phi edge-reachable from safepoint found!
...
declare i32 @llvm.jvmstate_0(i32, i32, i32, i32, i32) #2
...
bci_0:
  %3 = tail call i32 @llvm.jvmstate_0(i32 0, i32 0, i32 0, i32 0, i32 0)
...
not_zero179:                                      ; preds = %not_zero146, %bci_37-aload
  ...
  %safepoint_token = tail call  i32 (i32 ()*, i32, i32, i32, i32, i32, i32, i32, ...)* @llvm.statepoint.p0f_i32f(i32 ()* undef, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, %jObject addrspace(1)* %base_phi1, %jObject addrspace(1)* addrspace(1)* %base_phi4, %jObject addrspace(1)* addrspace(1)* %relocated4, %jObject addrspace(1)* %relocated7)
  %5 = call i32 @llvm.gc.result.int.i32(i32 %safepoint_token)
  %base_phi1.relocated = call coldcc %jObject addrspace(1)* @llvm.gc.relocate.p1jObject(i32 %safepoint_token, i32 8, i32 8)
  %base_phi4.relocated = call coldcc %jObject addrspace(1)* addrspace(1)* @llvm.gc.relocate.p1p1jObject(i32 %safepoint_token, i32 9, i32 9)
  %relocated4.relocated = call coldcc %jObject addrspace(1)* addrspace(1)* @llvm.gc.relocate.p1p1jObject(i32 %safepoint_token, i32 9, i32 10)
  %relocated7.relocated = call coldcc %jObject addrspace(1)* @llvm.gc.relocate.p1jObject(i32 %safepoint_token, i32 8, i32 11)
  %addr636 = bitcast %jObject addrspace(1)* addrspace(1)* %relocated4.relocated to %jNotAtSP addrspace(1)* addrspace(1)*
  br label %bci_37-aload
}

declare i32 @llvm.statepoint.p0f_i32f(i32 ()*, i32, i32, i32, i32, i32, i32, i32, ...)
