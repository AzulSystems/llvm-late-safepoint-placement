...
declare i32 @llvm.jvmstate_0(i32, i32, i32, i32, i32, %jObject addrspace(1)*, i32, %jObject addrspace(1)*, i32, %jObject addrspace(1)*) #1
...
entry:
  call i32 @llvm.jvmstate_0(i32 0, i32 0, i32 3, i32 0, i32 0, %jObject addrspace(1)* %0, i32 0, %jObject addrspace(1)* %1, i32 0, %jObject addrspace(1)* %2)
  br label %loop
