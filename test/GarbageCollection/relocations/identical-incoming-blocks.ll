...
declare i32 @llvm.jvmstate_0(i32, i32, i32, i32, i32, %jObject addrspace(1)*, i32, %jObject addrspace(1)*, i32, i8*, i32, i8*, i32, i8*, i32, i8*, i32, i8*, i32, i8*, i32, i8*, i32, i8*) #6

; Function Attrs: nounwind
define void @"sun.net.www.MessageHeader::mergeHeader"(%jObject addrspace(1)*, %jObject addrspace(1)*) #7 {
bci_0:
  %2 = tail call i32 @llvm.jvmstate_0(i32 0, i32 0, i32 10, i32 0, i32 12, %jObject addrspace(1)* %0, i32 12, %jObject addrspace(1)* %1, i32 99, i8* null, i32 99, i8* null, i32 99, i8* null, i32 99, i8* null, i32 99, i8* null, i32 99, i8* null, i32 99, i8* null, i32 99, i8* null)
