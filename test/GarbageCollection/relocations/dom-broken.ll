...
declare i32 @llvm.jvmstate_133(i32, i32, i32, i32, i32, i32, %jObject addrspace(1)*, i32, %jObject addrspace(1)*)
...
; CHECK: bci_371-iinc:                                     ; preds = %bci_203-dload
  %tmp = tail call i32 @llvm.jvmstate_133(i32 0, i32 203, i32 0, i32 2, i32 0, i32 0, %jObject addrspace(1)* %0, i32 0, %jObject addrspace(1)* %1)
