...
declare i32 @llvm.jvmstate_16(i32, i32, i32, i32, i32, i32, %jObject addrspace(1)*, i32, %jObject addrspace(1)*, i32, i32, i32, %jObject addrspace(1)*, i32, i32, i32, %jObject addrspace(1)*, i32, i32, i32, i32, i32, i8*, i32, i8*, i32, i8*, i32, i8*, i32, i8*, i32, i8*, i32, i8*) #2

declare  %jObject addrspace(1)* @"VMRuntime::newarray"([1768 x i8]*, i32, i32) #3

; Function Attrs: nounwind readonly
declare i32 @llvm.jvmstate_36(i32, i32, i32, i32, i32, i32, i32, i32, %jObject addrspace(1)*, i32, %jObject addrspace(1)*, i32, i32, i32, %jObject addrspace(1)*, i32, i32, i32, %jObject addrspace(1)*, i32, i32, i32, i32, i32, i64, i32, i8*, i32, i32, i32, i32, i32, i8*, i32, i8*, i32, i8*) #2
...
not_zero48:                                       ; preds = %not_zero48, %bci_0
  ...
  store volatile i32 %tmp7, i32* @llvm.jvmstate_anchor
; CHECK: poll.exit
; CHECK: not_zero48
  br label %not_zero48
}
