...
declare i32 @llvm.jvmstate_2(i32, i32, i32, i32, i32, i32, %jObject addrspace(1)*)

declare void @foo()

define  %jObject addrspace(1)* @test(%jObject addrspace(1)*) #0 {
bci_0:
  %1 = tail call i32 @llvm.jvmstate_2(i32 0, i32 0, i32 1, i32 0, i32 0, i32 0, %jObject addrspace(1)* %0)
