...
declare i32 @llvm.jvmstate_0(i32, i32, i32, i32, i32, i32, %jObject addrspace(1)*, i32, %jObject addrspace(1)*, i32, i32, i32, i8*, i32, i8*, i32, i8*, i32, i8*, i32, i8*, i32, i8*, i32, i8*) #7
...
; Function Attrs: nounwind readonly
declare i32 @llvm.jvmstate_52(i32, i32, i32, i32, i32, i32, %jObject addrspace(1)*, i32, %jObject addrspace(1)*, i32, i32, i32, i32, i32, i32, i32, i32, i32, %jObject addrspace(1)*, i32, i32) #7

; Function Attrs: nounwind
define  void @"java.util.HashMap::transfer"([160 x i8]* nocapture readnone %method, %jObject addrspace(1)*, %jObject addrspace(1)*, i32) #9 {
bci_0:
  %3 = tail call i32 @llvm.jvmstate_0(i32 0, i32 0, i32 0, i32 10, i32 0, i32 0, %jObject addrspace(1)* %0, i32 0, %jObject addrspace(1)* %1, i32 0, i32 %2, i32 0, i8* null, i32 0, i8* null, i32 0, i8* null, i32 0, i8* null, i32 0, i8* null, i32 0, i8* null, i32 0, i8* null)
...
not_zero179:                                      ; preds = %not_zero146, %not_zero107
  ...
  %6 = tail call i32 @llvm.jvmstate_52(i32 0, i32 101, i32 0, i32 10, i32 0, i32 0, %jObject addrspace(1)* %0, i32 0, %jObject addrspace(1)* %1, i32 0, i32 %2, i32 0, i32 undef, i32 0, i32 undef, i32 0, i32 0, i32 0, %jObject addrspace(1)* %local_7_83, i32 0, i32 %5)
  br label %bci_37-aload
}
